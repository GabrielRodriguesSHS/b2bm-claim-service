...
public class ServiceOrderKafkaConfig {
    ...
    public ServiceOrderKafkaConfig(KafkaConsumerConfig kafkaConsumerConfig, KafkaTemplate<String, ServiceOrderProto> serviceOrderConsumerTemplate) {
    ...
    public ConcurrentKafkaListenerContainerFactory<String, ServiceOrderProto> serviceOrderKafkaListenerContainerFactory(
        ...
        return kafkaConsumerConfig.kafkaListenerContainerFactory(this.serviceOrderConsumerFactory(), this.deadLetterPublishingRecovererTemplateServiceOrder());
    }
    ...
    private DefaultErrorHandler deadLetterPublishingRecovererTemplateServiceOrder() {
        return new DefaultErrorHandler(
                deadLetterPublishingRecovererServiceOrder(), new FixedBackOff(heartbeatIntervalMs, maxAttempts));
    }
