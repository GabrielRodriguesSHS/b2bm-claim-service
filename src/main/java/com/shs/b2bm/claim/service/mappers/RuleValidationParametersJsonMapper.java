...
/**
 * MapStruct mapper interface for converting JSON parameter details from {@link
 * RuleValidationConfig} to their corresponding DTO representations.
 */
@Mapper
public interface RuleValidationParametersJsonMapper {
  /** Singleton instance of the mapper. */
  RuleValidationParametersJsonMapper INSTANCE =
      Mappers.getMapper(RuleValidationParametersJsonMapper.class);

  /**
   * Converts the JSON parameter details from a {@link RuleValidationConfig} entity to a {@link
   * PartRulesDetailsDto}.
   *
  ...
  /**
   * Converts the JSON parameter details from a {@link RuleValidationConfig} entity to a {@link
   * SerialNumberRulesDetailsDto}.
   *
   * @param ruleValidationConfig the entity containing JSON parameter details
   * @return the mapped SerialNumberRulesDetailsDto, or null if conversion fails or parameters are
   *     absent
   */
  @Named("jsonToSerialNumberRulesDetailsDto")
  default SerialNumberRulesDetailsDto jsonToSerialNumberRulesDetailsDto(
