 ...
 * Provides validation strategies for different business rule types.
 */
public interface ValidationStrategyService {
   ...
   * Performs comprehensive validation checks based on the specific rule type
   * and returns detailed validation results including any errors found.
   *
